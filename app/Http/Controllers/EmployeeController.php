...
class EmployeeController extends Controller {
    ...
    public function all() {
        if ($response = $this->checkPermissionAndRespond('employees.view')) {
            return $response;
        }
    ...
    public function create(EmployeeRequest $request) {
        if ($response = $this->checkPermissionAndRespond('employees.create')) {
            return $response;
        }
    ...
    public function update(EmployeeRequest $request, $id) {
        if ($response = $this->checkPermissionAndRespond('employees.update')) {
            return $response;
        }
    ...
    public function delete($id) {
        if ($response = $this->checkPermissionAndRespond('employees.delete')) {
            return $response;
        }
