    ...
    <div class="flex items-center justify-between lg:justify-end">
        ...
        <div class="relative">
            ...
            <div id="dropdown-menu" class="absolute left-0 mt-2 w-48 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 z-50 hidden">
                <a href="{{ route('settings.account.get') }}" class="w-full flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-slate-700">
                ...
                <a href="{{ route('auth.logout') }}" class="w-full flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-slate-700">
